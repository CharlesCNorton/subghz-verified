...
Definition packet24_prefix12_check4_payload4_counter4_structure_spec
    : PacketStructureSpec :=
  [ {| packet_structure_role := PacketFieldPrefix;
       packet_structure_bits := packet24_prefix12_field |};
    {| packet_structure_role := PacketFieldCheck;
...
Definition packet24_prefix12_check4_boundary4_counter4_structure_spec
    : PacketStructureSpec :=
  [ {| packet_structure_role := PacketFieldPrefix;
       packet_structure_bits := packet24_prefix12_field |};
    {| packet_structure_role := PacketFieldCheck;
...
Definition packet24_prefix12_flag4_payload4_counter4_structure_spec
    : PacketStructureSpec :=
  [ {| packet_structure_role := PacketFieldPrefix;
       packet_structure_bits := packet24_prefix12_field |};
    {| packet_structure_role := PacketFieldFlag;
...
Definition packet24_prefix12_flag4_boundary4_counter4_structure_spec
    : PacketStructureSpec :=
  [ {| packet_structure_role := PacketFieldPrefix;
       packet_structure_bits := packet24_prefix12_field |};
    {| packet_structure_role := PacketFieldFlag;
